    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            using (db)
            {
                ...
                Show s3 = new Show() { ShowID = 3, Title = "The Office", Seasons = 9, Episodes = 201, YearStart = 2005, YearEnd = 2013, Description = "Mockumentary of a normal day to day in an paper company", ShowImage = "/Images/the office.jpg" };
                Show s4 = new Show() { ShowID = 4, Title = "Paradise PD", Seasons = 3, Episodes = 18, YearStart = 2018, YearEnd = null, Description = "Animated ventures of local police team", ShowImage = "/Images/paradisepd.png" };
